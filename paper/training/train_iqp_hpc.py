...
parser.add_argument('--bitflip', type=str)
parser.add_argument('--turbo', type=int, help='number of parallel jobs', default=None)
parser.add_argument('--param-file', type=str, help='init params', default=None)
...
bitflip = True if args.bitflip == 'True' else False  #to use the bitflip model or not
turbo = args.turbo
...
param_init_file = args.param_file
